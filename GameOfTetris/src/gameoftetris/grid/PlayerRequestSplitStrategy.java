...
/**
 * Sample implementation of IRequestSplitStrategy to split a single request into
 * multiple requests for workers.
 *
 * @author Klaus Meffert
 * @since 3.2
 */
public class PlayerRequestSplitStrategy implements IRequestSplitStrategy {

    private Configuration m_config;

    public PlayerRequestSplitStrategy(Configuration a_config) {
        m_config = a_config;
    }
    ...
    /**
     * Creates single requests to be sent to workers. Here, each request
     * consists of a single chromosome for which to calculate the fitness value.
     *
     * @param a_request
