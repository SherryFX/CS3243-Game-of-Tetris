 ...
 * @since 3.2
 */
public class PlayerWorkerReturnStrategy implements IWorkerReturnStrategy {
     ...
     */
    @Override
    public JGAPResult assembleResult(JGAPRequest a_req, Genotype a_genotype) throws Exception {
        ...
        MyResult result = new MyResult(a_req.getSessionName(), a_req.getRID(), pop, 1);
        return result;
    }
}