 ...
 * @since 3.01
 */
public class MyResult extends JGAPResult {
    ...
    public MyResult(String a_name, int a_id, IChromosome a_fittestChrom, long a_unitdone) {
        super(a_name, a_id, a_fittestChrom, a_unitdone);
    }

    public MyResult(String a_name, int a_id, Population a_pop, long a_unitdone) {
